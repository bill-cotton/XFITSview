...
/* Show Help dialog */
/* returns true if created, else previously existed */
...
/* find topic in list and select it */
...
"feature. \n",
"  \n",
"The FITSview home page is http://www.nrao.edu/software/fitsview/\n",
"*** FINISHED ***"}; /* end of text */

/* overview of XFITSview */
